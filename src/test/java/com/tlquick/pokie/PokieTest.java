...
public class PokieTest {
	...
	void testPokie_toString() {
		...
		pokie.betLines(3);
		pokie.spin();
		assertEquals("Cherry Bomb: payouts = $0.0 turnover = $3.0 spins = 1\nPlayer: bet $1.0 balance $97.0 games played 1", pokie.toString());
